...
$db = new Database();
$query = "SELECT recipes.* , admins.prenom , recipe_category.cat_name FROM recipes JOIN admins on recipes.admin_id = admins.admin_id JOIN recipe_category ON recipe_category.cat_id = recipes.cat_id WHERE recipes.title LIKE '%$_POST[search_text]%'  ORDER BY recipes.created_on  DESC LIMIT 6  ";
...
<div class=" col-12 col-md-9 mt-3 mb-1">
    <div class="row justify-content-center">
        ...
        <p class="text-secondary text-center h3"> Vos résultats de recherche </p>
